...
class speechEmotionRecognition:
    ...
    def __init__(self, subdir_model=None):
        ...
        # Emotion encoding
        self._emotion = {0: 'female_angry', 1: 'female_disgust', 2: 'female_fear', 3: 'female_happy',
                         4: 'female_neutral', 5: 'female_sad', 6: 'female_surprise', 7: 'male_angry',
                         8: 'male_disgust', 9: 'male_fear', 10: 'male_happy', 11: 'male_neutral',
                         12: 'male_sad', 13: 'male_surprise' }
    ...
    def frame(self, y, win_step=64, win_size=128):
        ...
        # Framming
        frames = np.zeros(
            (y.shape[0], nb_frames, y.shape[1], win_size)).astype(np.float16)
        for t in range(nb_frames):
            frames[:, t, :, :] = np.copy(
                y[:, :, (t * win_step):(t * win_step + win_size)]).astype(np.float16)
